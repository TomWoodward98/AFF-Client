<template>
    <div class="row text-right">
        <div class="col-3 dropdown">
            <div class="row">
                <div class="col-12">
                    <button class="btn btn-info dropdown-toggle" type="button" id="dropdownAllo" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Allocated to...
                    </button>
        ...
        <div class="col-3 dropdown">
            <div class="row">
                <div class="col-12">
                    <button class="btn btn-info dropdown-toggle" type="button" id="dropdownCreated" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Created by...
                    </button>
        ...
        <div class="col-3 dropdown">
            <div class="row">
                <div class="col-12">
                    <button class="btn btn-info dropdown-toggle" type="button" id="dropdownRaise" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Raised by..
                    </button>
        ...
        <div class="col-3 dropdown">
            <div class="row">
                <div class="col-12">
                    <button class="btn btn-info dropdown-toggle" type="button" id="dropdownStatus" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Status...
                    </button>
